...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433210879" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433210879"></script>
		...
		<div class="admin-main-content">
			...
			<div class="table-responsive well">
				...
				<div class="form-control-static">
					<form action="<?php echo U('Admin/Log/system');?>" method="post" class="form-inline">
				...
				<div class="form-control-static">
					<a href="<?php echo U('Admin/Log/bulkDelete');?>" class="confirm ajax-post btn btn-danger btn-sm" target-form="selectitem"><?php echo L('BTN_SELECTED_DELETE');?></a>
				</div>
				<table class="table table-striped table table-hover  table-condensed">
					<thead>
						<tr>
							<th>
								...
								<th>
									<?php echo L('VIEW_DATETIME');?>
								</th>
								<th>
									<?php echo L('VIEW_INFO');?>
								</th>
								<th>
									<?php echo L('OPERATOR');?>
								</th>
					...
					<tbody>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo (date("Y/m/d H:i:s",$vo["timestamp"])); ?></td>
								<td><?php echo ($vo["info"]); ?></td>
								<td>
									<a href="<?php echo U(CONTROLLER_NAME .'/view',array('id'=>$vo['id']));?>" class="btn btn-default btn-sm"><i class="fa fa-eye"></i><?php echo L('BTN_VIEW');?></a>
