...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433210964" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433210964"></script>
...
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/jquery-validation/1.13.1/jquery.validate.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/cdn/comp/wxuploader.css" />
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-lg-10">
							<input type="text" class="required form-control input-short" name="name" id="inputtitle" placeholder="请输入名称不要超过30个字">
							<div class="help-block">(请输入名称不要超过30个字)</div>
						</div>
					</div>
					<div class="form-group">
						<label for="inputtitle" class="col-md-2 col-lg-2 control-label">隐藏值</label>
						<div class="col-md-10 col-lg-10">
							<input type="text" class="required form-control input-short" name="hidden_value" id="inputhidden_value" placeholder="隐藏值，默认为空">
							<div class="help-block">(隐藏值，默认为空)</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-lg-10">
							<input type="text" class="required form-control input-short" value="0" name="sort"  placeholder="">
					...
					<div class="form-group">
						...
						<div class="col-lg-10 col-md-10">
							<a target-form="validateForm" onclick="return getData();" class="ajax-post btn btn-primary" href="<?php echo U('Admin/Datatree/add');?>" autofocus="autofocus"><i class="fa fa-save"></i> <?php echo L('BTN_SAVE');?></a>
							<a class="btn btn-default" href="<?php echo U('Admin/Datatree/index',array('parent'=>$parent));?>"><i class="fa fa-times-circle"></i> <?php echo L('BTN_CANCEL');?></a>
						</div>
					</div>
				</fieldset>
			</form>
