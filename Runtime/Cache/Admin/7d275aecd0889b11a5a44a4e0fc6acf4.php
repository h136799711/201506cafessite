...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433210974" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433210974"></script>
		...
		<div class="admin-main-content">
			...
			<!-- 过滤\查询按钮 -->
				<div class="filter-controls">
					<!-- 日期查询 -->
					<form action="<?php echo U('Admin/Datatree/search');?>" method="post" class="form-inline">
				...
				<div class="btn-controls">
					<a class="btn btn-primary btn-sm" href="<?php echo U('Admin/Datatree/add',array('parent'=>$parent));?>"><i class="fa fa-plus"></i><?php echo L('BTN_ADD');?></a>
					
					<?php if(($parent) != "0"): ?><a class="btn btn-default btn-sm" href="<?php echo U('Admin/Datatree/index',array('parent'=>$preparent));?>"><i class="fa fa-reply"></i>返回</a><?php endif; ?>
				</div>
					...
					<tbody>
						<?php if(empty($list)): ?><tr>
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<a href="<?php echo U('Admin/Datatree/index',array('parent'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a>
									</td>
									<td>
										<?php echo ($vo["parents"]); ?>
									</td>
									...
									<td>
										<a href="<?php echo U('Admin/Datatree/edit',array('id'=>$vo['id'],'parent'=>$vo['parentid']));?>" class="btn btn-sm btn-default"><i class="fa fa-edit"></i>编辑</a>
										<a href="<?php echo U('Admin/Datatree/delete',array('id'=>$vo['id'],'parent'=>$vo['parentid']));?>" class="btn btn-sm btn-danger ajax-get confirm"><i class="fa fa-trash"></i>删除</a>
									</td>
