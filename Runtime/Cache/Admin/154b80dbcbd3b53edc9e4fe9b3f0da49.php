...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433214146" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433214146"></script>
		...
		<div class="admin-main-content">
			...
			<div class="table-responsive well">
				...
				<div class="btn-controls">
					<a href="<?php echo U('Admin/Config/add');?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i><?php echo L('BTN_ADD');?></a>
				...
				<div class="filter-controls">
					<div class="btn-group">
					<?php if(is_array($config_groups)): $i = 0; $__LIST__ = $config_groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Admin/Config/index',array('group'=>$key));?>" class="btn btn-default <?php if(($_GET['group']) == $key): ?>active<?php endif; ?>" ><?php echo ($vo); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
				</div><?php endif; ?>
				<table class="table table-striped table table-hover  table-condensed">
					...
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="<?php echo U('Admin/Config/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i><?php echo L('BTN_EDIT');?></a>
									<a href="<?php echo U('Admin/Config/delete',array('id'=>$vo['id']));?>" class="confirm ajax-get btn btn-primary btn-sm"><i class="fa fa-trash-o"></i><?php echo L('BTN_DELETE');?></a>
								</td>
