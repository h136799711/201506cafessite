...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433214052" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433214052"></script>
		...
		<div class="admin-main-content">
			...
			<ul class="nav nav-tabs" role="tablist" id="configTab">
				<li role="presentation" class="">
					<a href="<?php echo U('Admin/WxreplyText/index');?>" role="tab" >文本回复</a>
				</li>
			...
			<div class="tab-content ">
				...
				<div role="tabpanel" class="tab-pane fade clearfix active in" id="tab1">
					<div class="controls">
						<a class="btn btn-primary btn-sm" href="<?php echo U('Admin/WxreplyNews/add');?>"><i class="fa fa-plus"></i>新增</a>
						<a href="<?php echo U('Admin/WxreplyNews/bulkDelete');?>" class="confirm ajax-post btn btn-danger btn-sm" target-form="selectitem"><i class="fa fa-trash"></i>删除</a>
						<div class="help-block">图文回复的关键词相同时，将自动组合成多图文！如果要回复多图文只要添加多个关键词相同的单图文即可</div>
					</div>
					...
					<table class="table table-striped table table-hover  table-condensed">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<!-- TODO:鼠标移上去展示大图 -->
									<td><a data-toggle="tooltip" data-placement="top" title="点击查看原图" href="<?php echo ($vo["picurl"]); ?>" target="_blank"><img src="<?php echo ($vo["picurl"]); ?>" class="thumbnail" style="width:40px;height:40px;" /></a></td>
									<td><?php echo (date("Y-m-d",$vo["updatetime"])); ?></td>
									<td>
										<a href="<?php echo U('Admin/WxreplyNews/edit',array('id'=>$vo['id']));?>" class="btn btn-sm btn-primary"><i class="fa fa-trash"></i>编辑</a>										
									</td>
