...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433212560" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433212560"></script>
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-10 col-md-10">
							<a target-form="validateForm" class="ajax-post btn btn-primary" href="<?php echo U('Admin/Menu/save',array('id'=>$entity['id']));?>" autofocus="autofocus"><i class="fa fa-save"></i> <?php echo L('BTN_SAVE');?></a>
							<a class="btn btn-default" href="<?php echo U('Admin/Menu/index',array('pid'=>$entity['pid']));?>"><i class="fa fa-times-circle"></i> <?php echo L('BTN_CANCEL');?></a>
						</div>
					</div>
				</fieldset>
			</form>
