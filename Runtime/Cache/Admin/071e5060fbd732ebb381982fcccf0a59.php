...
<!-- 自定义模块通用样式 -->
<link rel="stylesheet" type="text/css" href="/github/201506cafessite/Public/Admin/css/common.css?v=1433214056" />
<script type="text/javascript" src="/github/201506cafessite/Public/cdn/common/common.js?v=1433214056"></script>
	...
	<div class="admin-main container-fluid">
		...
		<div class="admin-main-content">
			...
			<form class="form well clearfix">
				<fieldset>
					<legend>（<?php echo ($wxaccount['wxname']); ?>）的服务器配置参数如下</legend>

					<div class="form-group"><span class="text-info ">URL(服务器地址)</span><?php echo C('SITE_URL'); echo U('Weixin/Connect/index',array('token'=>$wxaccount['token']));?></div>
					<div class="form-group"><span class="text-info ">TOKEN(令牌)</span> <?php echo md5($wxaccount['token']);?></div>
					<div class="form-group"><span class="text-info ">EncodingAESKey(消息加解密密钥)<sup><i class="fa fa-question" data-toggle="tooltip" data-placement="top" title="用于安全模式下。"></i></sup></span><?php echo ($wxaccount['encodingaeskey']); ?></div>
					<div class="form-group">
						<a class="btn btn-primary" href="http://mp.weixin.qq.com" target="_blank">前往微信公众平台</a>
					</div>
				</fieldset>
			</form>
		</div>
