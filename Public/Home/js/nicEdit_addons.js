var estilos_disponibles = {
                        "Título":"h2",
                        "Subtítulo":"h3",
                        "Texto peque":"<span class='texto-peque'>{{texto}}</span>",
                        "Texto negrita destacado":"<span class='negrita-destacado'>{{texto}}</span>",
						"Dest. caja amarilla":"<div class='destacado-caja-amarilla'>{{texto}}</div>",
						"Dest. telefono":"<span class='destacado-telefono'>{{texto}}</span>",
						 "Localizacion":"<a class='enlace-localizacion'>{{texto}}</a>",
						 "Título boletín":"<h2 style='font-family:Arial, Helvetica, sans-serif; font-size:15px;text-transform:uppercase;	margin:0; color:#cf031c!important; text-transform:uppercase; font-weight:normal;padding-bottom:4px;'>{{texto}}</h2>",
						"Subtítulo boletín":"<h3 style='margin:0; font-family:Arial, Helvetica, sans-serif; font-size:14px;color:#8f7f5c!important;font-weight:bold; margin:0;padding-bottom:3px; '>{{texto}}</h3>",
