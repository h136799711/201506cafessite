...
class ProductController extends  AdminController{
	...
	public function index(){
		...
		$cate_list = apiCall("Admin/Datatree/queryNoPaging", array(array("parentid"=>getDatatree("PRODUCT_CATE"))));
		if(!$cate_list['status']){
	...
	public function add(){
		if(IS_GET){
			...
			$post_category = I('post.post_category',getDatatree("PRODUCT_CATE"));
	...
	public function edit(){
		...
		if(IS_GET){
			...
			$this->success("保存成功！",U('Admin/Product/index'));
