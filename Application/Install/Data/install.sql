...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-06-02 06:15:41
-- 服务器版本： 5.6.22
-- PHP Version: 5.6.7
...
--
-- Database: `boye_2015_06_02_09_58_40`
--
...
(1, 'WEBSITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '网站管理系统', 0),
(2, 'WEBSITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '网站管理系统', 1),
(3, 'WEBSITE_KEYWORDS', 0, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '网站管理系统', 0),
(9, 'CONFIG_TYPE_LIST', 3, '配置类型列表', 4, '', '主要用于数据解析和页面表单的生成', 1378898976, 1379235348, 1, '0:数字\r\n1:字符\r\n2:文本\r\n3:数组\r\n4:枚举\r\n5:图片地址', 2),
(10, 'WEBSITE_ICP', 1, '网站备案号', 1, '', '设置在网站底部显示的备案号，如“沪ICP备12007941号-2', 1378900335, 1379235859, 1, '浙ICP备12007941号', 9),
...
(42, 'UCENTER_PLATFORM', 1, '管理平台名称', 1, '', '', 1420006808, 1420006808, 1, '网站管理系统', 1),
...
(30, '', '企业新闻', 0, 1433210972, 1433210972, '0,21,', 21, '', 1, '', 1, '1');
...
(254, '会员添加', 253, 0, 'Admin/CafeMember/add', 0, '', '', 0, 1),
(253, '会员模块', 249, 0, '#', 0, '', '', 0, 1),
...
(259, '公众号绑定', 257, 0, 'Admin/Wxaccount/help', 0, '', '', 0, 1),
(260, '基础模块', 256, 50, '#', 0, '', '', 0, 1),
(261, '自定义回复', 260, 0, 'Admin/WxreplyText/index', 0, '', '', 0, 1),
(262, '自定义菜单', 260, 0, 'Admin/Wxmenu/index', 0, '', '', 0, 1),
(263, '会员模块', 256, 40, '#', 0, '', '', 0, 1),
(264, '会员管理', 263, 0, 'Admin/Wxuser/index', 0, '', '', 0, 1),
(265, '日志模块', 256, 0, '#', 0, '', '', 0, 1),
(266, '微信交互日志', 265, 0, 'Admin/WeixinLog/index', 0, '', '', 0, 1),
(255, '会员管理', 253, 0, 'Admin/CafeMember/index', 0, '', '', 0, 1),
(256, '微信', 0, 0, 'Admin/Wxaccount/change', 0, '', '', 0, 1),
(257, '公众号管理', 256, 60, '#', 0, '', '', 0, 1),
(258, '公众号信息', 257, 0, 'Admin/Wxaccount/edit', 0, '', '', 0, 1),
(249, '网站', 0, 0, 'Admin/Post/index', 0, '', '', 0, 1),
...
(4, 'http://mmbiz.qpic.cn/mmbiz/PqyU7gZWXQCRdm3JsukkPxYGiar2eJ2PFv0ibia2ms5npZARu62e7pKl8iacrIRQx0jf99dtLhsggEMMaia0g4oHYxg/0', '18', '', 34, -1, 1429668686, 'Test', '', 0, 0, 0),
(5, 'http://mmbiz.qpic.cn/mmbiz/PqyU7gZWXQCRdm3JsukkPxYGiar2eJ2PFLY1IaHcFQ4ibKCjF2mQvMqWmQZhCgBUrh9J67fz4LRU2wLwjaeB9Xzg/0', '18', '', 34, -1, 1429668739, 'test', '', 0, 0, 0);
...
(1, 1433214122, 'a:3:{s:5:"Event";s:9:"subscribe";s:7:"MsgType";s:4:"text";s:7:"Content";s:4:"Home";}', '【来自微信服务器消息】');
...
CREATE TABLE IF NOT EXISTS `itboye_wxaccount` (
  ...
  `createtime` int(11) NOT NULL COMMENT '创建时间',
  `updatetime` int(11) NOT NULL COMMENT '更新时间',
  `ss_keyword` varchar(64) NOT NULL COMMENT '首次关注时回复关键词',
...
INSERT INTO `itboye_wxaccount` (`id`, `wxname`, `appid`, `appsecret`, `encodingAESKey`, `token`, `uid`, `weixin`, `headerpic`, `createtime`, `updatetime`, `ss_keyword`, `wxuid`, `qrcode`) VALUES
(1, '奥肯多', 'wx5f9ed360f5da5370', '4a0e3e50c8e9137c4873689b8ee99124', 'pymaghvltbj74b7joasnfb6jqni952hqktv8vuv0mxp', 'eotprkjn1426473619', 1, 'wytongchenghui', 'https://mp.weixin.qq.com/misc/getheadimg?token=1095614112&amp;fakeid=3002360260&amp;r=546222', 1426473618, 1433213839, 'Home', 'gh_203b043c7e69', 'http://mmbiz.qpic.cn/mmbiz/PqyU7gZWXQCC5X8WQBZ66ZJvQ2Re83qlUUWBB0wDiag1RpQTXuBpe95bXdo9HhUcgnTeB8NhwRJ1s2FgDnvGWCQ/0');
...
--
-- 表的结构 `itboye_wxshop_picture`
--

CREATE TABLE IF NOT EXISTS `itboye_wxshop_picture` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `itboye_wxuser` (
  ...
  `createtime` int(11) NOT NULL COMMENT '数据创建时间',
  `updatetime` int(11) NOT NULL COMMENT '信息更新时间',
...
CREATE TABLE IF NOT EXISTS `itboye_wxuser_family` (
  ...
  `parent_5` int(11) NOT NULL DEFAULT '0' COMMENT '父5级',
  `createtime` int(11) NOT NULL,
  `wxaccount_id` int(11) NOT NULL COMMENT 'wxaccount表id，外键\n',
  `openid` char(32) NOT NULL COMMENT 'openid',
  PRIMARY KEY (`id`)
